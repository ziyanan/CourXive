        ...
        axios
          ...
          .then((res) => {
           console.log("response", res)
            axios.post("http://localhost:5000/api/profile/update",{...formData,image:res.data.secure_url})
            .then((val)=>{
          ...
          .catch((err) => console.log(err));
            ...
            axios.post("http://localhost:5000/api/profile/update",{...formData,image:prevImage})
            .then((val)=>{
              const structData = {
                token:authUser.token,
                user:{
